    ...
    return (
        <>
                ...
                <div className={style.productNavigationWrapper}>
                    <Container>
                        <ul>
                            ...
                            <li>
                                <Link href="#description">Наши преимущества</Link>
                            </li>
                        </ul>
                    </Container>
                </div>
            ...
            <section className={style.productDescription} id="description">
                ...
                <Container>
                    <strong>Наши полуприцепы полностью адаптированы к условиям эксплуатации на территории РФ!</strong>
                    <h3>Рама:</h3>
                    <p>При обработке рамы Полуприцепа «AUCMA» используется технология KTL (Kombinierter Rost- und Lackierverfahren). Этот процесс включает несколько этапов, которые обеспечивают высокую степень защиты от коррозии и внешних воздействий. Технология KTL позволяет значительно увеличить срок службы полуприцепов за счет высокой степени защиты от атмосферных воздействий, механических повреждений и коррозии.</p> 
                    <p>Рама Полуприцепа «AUCMA» представляет собой усиленную стальную конструкцию из продольных лонжеронов и поперечных балок, изготовленных из стали повышенной прочности. Конструкция рамы разработана инженерами завода «AUCMA» с учетом особенностей эксплуатации на территории РФ, что позволило снизить массу полуприцепа без потери прочности и жесткости рамы.</p>
                    ...
                    <div className={style.productDescriptionBlock}>
                        ...
                        <div className={style.productDescriptionContent}>
                            ...
                            <p>Электрическая система напряжением 24В, передний разъем имеет одну 7-жильную розетку (ISO 1185) и одну 15-жильную розетку (ISO 12098) с одной 7-жильной основной схемой (ISO 1185)</p>
                        </div>
                    </div>
